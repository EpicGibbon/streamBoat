...
const getBands = () => {
    API.getUserArtists(user._id)
        .then(res => {
            ...
            //             <Button.Content visible>Edit: {band.bandname}</Button.Content>
            //         </Button>
...
class EditUserForm extends Component {
    ...
    render() {
        return (
            <>
                <Form onSubmit={this.props.handleSubmit(this.props.onSubmit)} size='large'>
                    <Segment>
                        <Field
                            name="firstname"
